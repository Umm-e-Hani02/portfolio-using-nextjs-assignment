      ...
      <div className="flex flex-col items-center lg:flex-row lg:space-x-16">
        ...
        <div className="mt-8 lg:mt-0 lg:text-left text-center max-w-lg">
          ...
          <p className="mt-4">
            ...
            for technology and innovation. I am currently part of the Governor Sindh IT Initiative where I am
            ...
            constant learning and am excited about all the future holds. Lets connect on LinkedIn or GitHub to
